...
function ShaderPlane({ shiftY = 0 }: { shiftY?: number }) {
    ...
    // Use the larger dimension to ensure coverage while maintaining aspect ratio
    const size = Math.max(viewport.width, viewport.height) * 1.5;

    return (
        <mesh ref={meshRef} position={[0, shiftY, -0.5]}>
...
export function ShaderBackground({ shiftY = 0 }: ShaderBackgroundProps) {
